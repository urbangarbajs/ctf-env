...
(4,4,'Izvozniki pričakujejo previdno, a stabilno poletje','Naročila ostajajo zmerna, največ negotovosti je pri transportnih stroških.','Gospodarska zbornica vidi priložnost v nišnih izdelkih in večji avtomatizaciji. Podjetja medtem opozarjajo na pomanjkanje usposobljenih kadrov.', '2026-05-15 09:05:00',0),
...
(5,5,'Policija opozarja na lažna obvestila dostavnih služb','Prevaranti pošiljajo povezave za domnevno doplačilo poštnine.','Uporabnikom svetujejo, naj ne vpisujejo podatkov o karticah na povezavah iz sporočil. V primeru škode naj shranijo posnetke zaslona in obvestijo banko.', '2026-05-15 06:55:00',1),
...
(6,6,'Košarkarji Olimpije začeli finalno serijo z zmago','Odločila je natančna igra v zadnjih petih minutah.','Trener je po tekmi pohvalil skok in obrambo na zunanji liniji. Naslednja tekma bo v petek zvečer.', '2026-05-15 05:50:00',0),
...
(7,7,'Festival dokumentarnega filma odpira zgodba o gorah','Program vključuje pogovore z avtorji in projekcije za dijake.','Organizatorji želijo letos več prostora nameniti domačim produkcijam. Vstopnice za večerni program so skoraj razprodane.', '2026-05-15 11:20:00',0),
...
(8,8,'Slovenski startup razvil senzor za pametne rastlinjake','Naprava meri vlago, temperaturo in hranila ter podatke pošilja v oblak.','Ekipa cilja predvsem na manjše pridelovalce, ki potrebujejo cenovno dostopen nadzor. Prve testne postavitve že delujejo v Pomurju.', '2026-05-15 12:05:00',0),
...
(9,9,'Popoldne možne plohe, jutri sveže in vetrovno','Največ padavin pričakujejo v zahodni Sloveniji in ob hribovitih pregradah.','Vremenoslovci svetujejo spremljanje radarske slike pred potjo. Ob morju bo pihal zmeren jugozahodnik, zvečer se bo ozračje umirilo.', '2026-05-15 06:20:00',0),
